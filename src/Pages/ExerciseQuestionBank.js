...
import QuestionBankComponent from "../Components/Question/Exercise/QuestionBankComponent";
import AddNewQuestion from "../Components/Question/Exercise/AddNewQuestion";
// import CategoryComponent from "../Components/Question/CategoryComponent";
const { Content } = Layout;
const { TabPane } = Tabs;

const ExerciseQuestionBank = () => {
  return (
    <Col span={24}>
...
export default ExerciseQuestionBank;
